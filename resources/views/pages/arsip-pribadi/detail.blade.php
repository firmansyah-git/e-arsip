    ...
    <div class="main-container">
        ...
        <nav class="font-medium text-gray-500 mb-4" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                <li class="flex items-center">
                    <a href="/arsip_pribadi" class="text-gray-500 hover:text-gray-700 transition duration-300">Arsip</a>
        ...
        <section class="section">
            ...
            <div class="flex gap-x-2 ml-4 mt-2">
                <a href="/arsip_pribadi/{{ $surat->id }}/edit" class="button bg-blue-500 hover:bg-blue-600">Ubah</a>
                <form action="/arsip_pribadi/{{ $surat->id }}" method="post">
                    @method('delete')
                    @csrf
