        ...
        <section class="section mb-4 p-8">
            ...
            <form action="/arsip/{{ $surat->id }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="isi" id="isi" class="input-group @error('isi') is-invalid @enderror" value="{{ old('isi',$surat->isi) }}}">
                    @error('isi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>  
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="file_surat" id="file_surat" class="input-group @error('file_surat') is-invalid @enderror" value="{{ old('file_surat',$surat->file_surat) }}">
                    @error('file_surat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>  
